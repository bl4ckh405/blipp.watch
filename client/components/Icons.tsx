...
export const HomeIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 9.75 12 3l9 6.75M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
  </svg>
);

export const DiamondIcon: React.FC<IconProps> = (props) => (
  // Using a cleaner Diamond/Sparkle shape for "Alpha"
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12 11.204 3.045c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" opacity="0" /> 
    <path strokeLinecap="round" strokeLinejoin="round" d="m21.75 12-8.955 8.955a1.125 1.125 0 0 1-1.591 0L2.25 12M12 2.25l8.955 8.955M2.25 12 11.204 3.045" opacity="0" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.07 4.93 17.656 6.343m-9.9 9.9 9.9-9.9m-9.9 9.9L6.342 17.657m1.414-1.414L6.342 17.657m12.728-12.728L17.657 6.343M12 2.25l-9.75 9.75 9.75 9.75 9.75-9.75L12 2.25Z" />
  </svg>
);
...
export const LiveIcon: React.FC<IconProps> = (props) => (
  // A radio/broadcast tower style for LIVE
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <circle cx="18" cy="6" r="3" fill="currentColor" className="text-rose-500 animate-pulse" />
  </svg>
);
...
export const CoinIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-6h6m-6 0a9 9 0 1 1 18 0 9 9 0 0 1-18 0Z" /></svg>
);
...
export const LoadingIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" {...props}>
    <path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M12 2.75V5.25" opacity=".4" />
    <path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M12 18.75V21.25" />
    <path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M4.687 19.313 6.437 17.563" opacity=".5" />
    <path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M17.563 6.437 19.313 4.687" />
    <path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M2.75 12H5.25" opacity=".6" />
    <path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M18.75 12H21.25" />
    <path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M4.687 4.687 6.437 6.437" opacity=".7" />
    <path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M17.563 17.563 19.313 19.313" opacity=".3" />
  </svg>
);
...
export const PlayIconSolid: React.FC<IconProps> = (props) => (
...
export const ViewersIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" {...props}>
...
export const ShareProfileIcon: React.FC<IconProps> = (props) => (
...
export const EyeIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639l4.433-7.447A1.012 1.012 0 0 1 7.25 4h9.5a1.012 1.012 0 0 1 .781.375l4.433 7.447a1.012 1.012 0 0 1 0 .639l-4.433 7.447A1.012 1.012 0 0 1 16.75 20h-9.5a1.012 1.012 0 0 1-.781-.375L2.036 12.322ZM15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" /></svg>
);
